...
public class House implements Serializable {
    ...
    public House(long id, String name, LocalDateTime dateOfSale, HouseAddress houseAddress, Set<Integer> apartments, School school) {
        setId(id);
        setName(name);
    ...
    public void setId(long id) {
        ...
        boolean alreadyAdded = House.houses.stream().anyMatch(h -> h.getId() == id);
...
// ekstensja trwala save & load
    ...
    public void setHouseAddress(HouseAddress houseAddress) throws IllegalArgumentException {
        if (houseAddress == null) {
            throw new IllegalArgumentException("qualifide.House address cannot be null.");
        }
    ...
    public void setApartments(Set<Integer> apartments) throws IllegalArgumentException {
        ...
        if (apartments.size() < minimumApartmentsNumber) {
            throw new IllegalArgumentException("In qualifide.House must be more than " + minimumApartmentsNumber + " apartments.");
        }
