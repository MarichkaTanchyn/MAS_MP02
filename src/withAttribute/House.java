...
public class House implements Serializable {
    ...
    private static void addHouse(House house) throws IllegalArgumentException {
        if (house == null) {
            throw new IllegalArgumentException("withAttribute.qualifide.House cannot be null");
        }
        boolean alreadyAdded = House.houses.stream().anyMatch(h -> h.getId() == house.getId());
        if (alreadyAdded) {
            throw new IllegalArgumentException("withAttribute.qualifide.House with id " + house.getId() + " has already been added");
        }
    ...
    private static void removeHouse(House house) throws IllegalArgumentException {
        ...
        if (alreadyDeleted) {
            throw new IllegalArgumentException("withAttribute.qualifide.House with id " + house.getId() + " has already been deleted");
        }
...
// ekstensja trwala save & load
    ...
    public void setHouseAddress(HouseAddress houseAddress) throws IllegalArgumentException {
        if (houseAddress == null) {
            throw new IllegalArgumentException("withAttribute.qualifide.House address cannot be null.");
        }
    ...
    public void setApartments(Set<Integer> apartments) throws IllegalArgumentException {
        ...
        if (apartments.size() < minimumApartmentsNumber) {
            throw new IllegalArgumentException("In withAttribute.qualifide.House must be more than " + minimumApartmentsNumber + " apartments.");
        }
    ...
    public String toString() {
        return "withAttribute.qualifide.House{" +
                "id=" + id +
                ", name='" + name + '\'' +
