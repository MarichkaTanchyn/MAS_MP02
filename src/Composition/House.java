...
public class House implements Serializable {
    ...
    private House(long id, String name, LocalDateTime dateOfSale, HouseAddress houseAddress, Set<Integer> apartments, HousingComplex housingComplex) {
        setId(id);
        setName(name);
    ...
    // Association methods
    public static void createHouse(HousingComplex housingComplex, long id, String name, LocalDateTime dateOfSale, HouseAddress houseAddress, Set<Integer> apartments) {
        if (housingComplex == null) {
            throw new IllegalArgumentException("House complex cannot be null.");
        }

        House house = new House(id, name, dateOfSale, houseAddress, apartments, housingComplex);
        housingComplex.addHouse(house);
    }
    ...
    public void setHousingComplex(HousingComplex housingComplex) {
        if (housingComplex == null) {
            throw new IllegalArgumentException("Part of housing complex cannot exist on its own");
        }
    ...
    public static void removeHousesFrom(HousingComplex housingComplex) {
        housingComplex.getHouses().forEach(h -> House.houses.remove(h));
    }
...
// ekstensja trwala save & load
    ...
    public void setApartments(Set<Integer> apartments) throws IllegalArgumentException {
        ...
        if (apartments.size() < minimumApartmentsNumber) {
            throw new IllegalArgumentException("In Composition.basic.withAttribute.qualifide.House must be more than " + minimumApartmentsNumber + " apartments.");
        }
    ...
    public String toString() {
        return "Composition.basic.withAttribute.qualifide.House{" +
                "id=" + id +
                ", name='" + name + '\'' +
